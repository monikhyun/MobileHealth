    ...
    private void seedExercises() {
        List<Exercise> exercises = List.of(
                ...
                Exercise.builder()
                        ...
                        .exerciseImagePath("https://res.cloudinary.com/de9xq9br5/image/upload/v1749420828/pull_up_ouajmt.png")
                        .build(),
                Exercise.builder()
                        .category(BodyPart.BACK)
                        .exerciseName("랫 풀 다운")
                        ...
                        .exerciseImagePath("https://res.cloudinary.com/de9xq9br5/image/upload/v1749420797/Lat_Pull_Down_sq90jq.png")
                        .build(),
                Exercise.builder()
                        .category(BodyPart.BACK)
                        ...
                        ).exerciseImagePath("https://res.cloudinary.com/de9xq9br5/image/upload/v1749420685/bent_over_row_urqgs1.png")
                        .build(),
                Exercise.builder()
                        .category(BodyPart.BACK)
                        .exerciseName("원 암 로우")
                        ...
                        ).exerciseImagePath("https://res.cloudinary.com/de9xq9br5/image/upload/v1749420819/one_arm_row_koq0tc.png")
                        .build(),
                ...
                Exercise.builder()
                        ...
                        ).exerciseImagePath("https://res.cloudinary.com/de9xq9br5/image/upload/v1749420845/squat_ffni8e.png")
                        .build(),
                Exercise.builder()
                        .category(BodyPart.LOWER_BODY)
                        .exerciseName("런지")
                        ...
                        ).exerciseImagePath("https://res.cloudinary.com/de9xq9br5/image/upload/v1749420815/lunge_jvh0dh.png")
                        .build(),
                Exercise.builder()
                        .category(BodyPart.LOWER_BODY)
                        .exerciseName("레그 프레스")
                        ...
                        ).exerciseImagePath("https://res.cloudinary.com/de9xq9br5/image/upload/v1749420810/leg_press_mdr4ij.png")
                        .build(),
                Exercise.builder()
                        .category(BodyPart.LOWER_BODY)
                        ...
                        ).exerciseImagePath("https://res.cloudinary.com/de9xq9br5/image/upload/v1749420806/leg_extension_hygdmj.png")
                        .build(),
                Exercise.builder()
                        .category(BodyPart.LOWER_BODY)
                        .exerciseName("레그 컬")
                        ...
                        ).exerciseImagePath("https://res.cloudinary.com/de9xq9br5/image/upload/v1749420801/leg_curl_cqdxnx.png")
                        .build(),
                Exercise.builder()
                        .category(BodyPart.LOWER_BODY)
                        .exerciseName("데드리프트")
                        ...
                        ).exerciseImagePath("https://res.cloudinary.com/de9xq9br5/image/upload/v1749420770/deadlift_qp44iz.png")
                        .build(),
                ...
                Exercise.builder()
                        ...
                        ).exerciseImagePath("https://res.cloudinary.com/de9xq9br5/image/upload/v1749420823/overhead_press_apyrwa.png")
                        .build(),
                Exercise.builder()
                        .category(BodyPart.SHOULDERS)
                        ...
                        ).exerciseImagePath("https://res.cloudinary.com/de9xq9br5/image/upload/v1749420841/side_raise_dwrnsz.png")
                        .build(),
                Exercise.builder()
                        .category(BodyPart.SHOULDERS)
                        ...
                        ).exerciseImagePath("https://res.cloudinary.com/de9xq9br5/image/upload/v1749420781/front_raise_dgrkyt.png")
                        .build(),
                Exercise.builder()
                        .category(BodyPart.SHOULDERS)
                        ...
                        ).exerciseImagePath("https://res.cloudinary.com/de9xq9br5/image/upload/v1749420836/reverse_fly_hjk0ih.png")
                        .build(),
                ...
                Exercise.builder()
                        ...
                        ).exerciseImagePath("https://res.cloudinary.com/de9xq9br5/image/upload/v1749420738/benchpress_sr8pgy.png")
                        .build(),
                Exercise.builder()
                        .category(BodyPart.CHEST)
                        ...
                        ).exerciseImagePath("https://res.cloudinary.com/de9xq9br5/image/upload/v1749420791/incline_bench_bj8tyb.png")
                        .build(),
                Exercise.builder()
                        .category(BodyPart.CHEST)
                        ...
                        ).exerciseImagePath("https://res.cloudinary.com/de9xq9br5/image/upload/v1749420756/chest_fly_kpf2vj.png")
                        .build(),
                Exercise.builder()
                        .category(BodyPart.CHEST)
                        ...
                        ).exerciseImagePath("https://res.cloudinary.com/de9xq9br5/image/upload/v1749420711/cable_cross_over_plsfz1.png")
                        .build(),
                ...
                Exercise.builder()
                        ...
                        ).exerciseImagePath("https://res.cloudinary.com/de9xq9br5/image/upload/v1749420702/biceps_curl_utuhry.png")
                        .build(),
                Exercise.builder()
                        .category(BodyPart.ARMS)
                        .exerciseName("해머 컬")
                        ...
                        ).exerciseImagePath("https://res.cloudinary.com/de9xq9br5/image/upload/v1749420787/hammer_curl_tct1lf.png")
                        .build(),
                Exercise.builder()
                        .category(BodyPart.ARMS)
                        ...
                        ).exerciseImagePath("https://res.cloudinary.com/de9xq9br5/image/upload/v1749420847/triceps_pushdown_z8vpjw.png")
                        .build(),
                Exercise.builder()
                        .category(BodyPart.ARMS)
                        .exerciseName("딥스")
                        ...
                        ).exerciseImagePath("https://res.cloudinary.com/de9xq9br5/image/upload/v1749420778/dips_stjiqz.png")
                        .build()
        );
